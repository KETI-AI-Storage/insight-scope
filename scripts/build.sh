...
IMAGE_NAME="ketidevit2/insight-scope"
TAG="${1:-latest}"

echo "=============================================="
echo "  Insight Scope - Build Script"
...
mkdir -p bin
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o bin/insight-scope ./cmd/main.go
echo "Binary built: bin/insight-scope"
